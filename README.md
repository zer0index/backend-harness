...
| **guidelines/guideline.md** | Universal coding standards for Figma Make | Template-based |
| **docs/FIGMA_MAKE_PROMPT.md** | Project-specific kickoff prompt | Customized for your API |
...
# 5. For Figma Make: Copy guideline and use kickoff prompt
cp my_api/guidelines/guideline.md [figma-make-project]/guidelines/
# Upload docs/app_spec.txt, docs/QUICKSTART.md, docs/mock-data/, openapi.json
# Paste docs/FIGMA_MAKE_PROMPT.md into Figma Make chat
```
...
│   ├── FIGMA_MAKE_PROMPT.md # Auto-generated kickoff (customized)
│   └── mock-data/
│       ├── README.md
...
│       ├── QUICKSTART_TEMPLATE.md            # ⭐ NEW - Lean integration guide
│       ├── FRONTEND_HANDOFF_TEMPLATE.md      # Reference (pagination/errors updated)
│       ├── MOCK_DATA_README_TEMPLATE.md
│       ├── FIGMA_MAKE_GUIDELINE_TEMPLATE.md
│       ├── FIGMA_MAKE_PROMPT_TEMPLATE.md
│       └── README_FIGMA_TEMPLATES.md
